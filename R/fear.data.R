...
#' \item wars. #' wars in progress in country year
...
#' \item numlang. #' languages in Ethnologue > min(1% pop, 1mill)
...
#' \item sdwars. #' Sambanis/Doyle civ wars in progress
#' \item sdonset. onset of Sambanis/Doyle war
#' \item colwars. #' Collier/Hoeffler wars in progress
#' \item colonset. onset of Collier/Hoeffler war
#' \item cowwars. #' COW civ wars in progress
...
#' @references FEARON, J., & LAITIN, D. (2003). Ethnicity, Insurgency, and Civil War. 
